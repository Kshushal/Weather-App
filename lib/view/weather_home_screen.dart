                ...
                child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(colors: [
                        Color.fromARGB(255, 137, 218, 210),
                        Color.fromARGB(255, 117, 225, 246),
                            ...
                            children: [
                              weatherController.cardSwitch.value
                                  ...
                                  : Padding(
                                      ...
                                      child: Text(
                                        "Current Weather at ${weatherData.city?.name}",
                              ...
                              Padding(
                                ...
                                child: AnimatedToggleSwitch<bool>.dual(
                                  current: weatherController.cardSwitch.value,
                                  first: false,
                                  second: true,
                                  spacing: 25.0,
                                  style: const ToggleStyle(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color: Color.fromARGB(66, 24, 178, 205),
                                        spreadRadius: 1,
                                        blurRadius: 2,
                                        offset: Offset(0, 1.5),
                                      ),
